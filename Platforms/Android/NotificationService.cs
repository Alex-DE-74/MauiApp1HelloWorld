...
public void SysAlert0(Android.Content.Context context)
{
...
public void ZeigeKritischeNotificationVx(Android.Content.Context context)
{
    ...
    else
    {
        ...
        var fullScreenPendingIntent = Android.App.PendingIntent.GetActivity(
            ...
            99, 
            fullScreenIntent, 
            Android.App.PendingIntentFlags.UpdateCurrent | Android.App.PendingIntentFlags.Mutable); // Mutable wird für FullScreenIntent benötigt 
